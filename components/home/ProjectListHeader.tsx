...
export function ProjectListHeader() {
  return (
    <div className="box-border flex min-w-[813px] items-center gap-3 border-b border-stiko-divider bg-stiko-wash px-[14px] py-[9px] text-[10px] font-bold uppercase tracking-label text-stiko-faint">
      ...
      {/* Matches ProjectListRow's trailing ⤢ (manage) cell — empty here the
          ...
          of alignment with the row below. The header does NOT take the row's
          hover slide: the row's three data cells shift left under it on
          hover by design, which is the whole point of the gap. */}
