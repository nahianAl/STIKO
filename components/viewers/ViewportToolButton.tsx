  ...
  return (
    <div className="group relative flex">
      <button
        ...
        aria-pressed={active}
        onClick={onClick}
        className={`relative flex h-[34px] w-[34px] items-center justify-center rounded-[11px] border shadow-stiko-panel transition-all duration-150 hover:scale-[1.12] hover:z-10 hover:shadow-[0_5px_12px_-3px_rgba(28,32,48,0.22)] ${
          active
            ? 'border-stiko-primary-light bg-stiko-tint text-stiko-primary'
            : 'border-stiko-border bg-white text-stiko-secondary hover:bg-[#F8EDFC] hover:border-stiko-border-strong'
        }`}
      >
        {children}
      </button>
