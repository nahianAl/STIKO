...
<div className="mt-3">
  <label className="flex items-center gap-2 text-[11.5px] text-stiko-muted">
    ...
    />
    AI summaries — to generate them, comment text, file names, and package and
    project names are sent to Atlas Cloud. Reviewer names are replaced with
    labels and never sent, and neither are the files themselves. Turning this
    off deletes the summaries already generated for this project.
  </label>
